...
INSERT INTO configuration (id,
                           ...
                           value)
VALUES ('ROLES', 'string[]',
        'ADMIN,SETTER,SPRAYER,INSPECTOR,STACKING,PALLETISING,WRAPPING,RACKING,LOGISTICS,FLT'),
       ...
       ('PRODUCTCSV', 'string[]',
        'part=PART No.,owner=OWNER,material=MATERIAL,profile=PROFILE,edge=EDGE,format=FORMAT,dimensions=Dimensions,thickness=THICKNESS,pitch=PITCH,machinery=MACHINERY,enabled=AVAILABLE,racktype=RACKTYPE,finish=FINISH,packsize=PACK SIZE,freeissue=FREE ISSUE'),
       ('CUSTOMERCSV', 'string[]',
        'code=CB6 CODE,name=CUSTOMER,zone=ZONE,contact=CONTACT,contactNumber=MOBILE,proforma=PROFORMA,enabled=ENABLED'),
       ('NEXTJOB', 'int', '20000'),
       ('DATA', 'string', 'C:\data\'),
