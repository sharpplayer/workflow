...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Material', 'PRODUCT(material)', 1, 1),
                      ...
                      ('Manufacture: Start', 'Start', 'SCHEDULE', 3, 1),
                      ...
                      ('Manufacture: First Off', 'First Off', 'SCHEDULE', 3, 1),
                      ...
                      ('Manufacture: First Off QC Inspection', 'RPI', 'CHECK(RPI)', 3, 11),
                      ...
                      ('Manufacture: Completion', 'Machinery', 'SCHEDULE', 3, 1),
