...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Start', 'AWAIT(LOGISTICS)', 3, 1),
                      ...
                      ('Material Logistics', 'From Location', '', 1, 3),
                      ('Material Logistics', 'To Location', '', 3, 4),
                      ...
                      ('Manufacture: First Off QC Inspection (Multiple Operative)', 'Inspector', 'SIGN(INSPECTOR)', 3,
                       12),
                      ('Manufacture: RPI Data and QC Inspection', 'Quantity', 'int', 3, 1),
                      ('Manufacture: RPI Data and QC Inspection', 'Width', 'int', 3, 2),
                      ('Manufacture: RPI Data and QC Inspection', 'Left', 'float', 3, 3),
                      ('Manufacture: RPI Data and QC Inspection', 'Centre', 'float', 3, 4),
                      ('Manufacture: RPI Data and QC Inspection', 'Right', 'float', 3, 5),
                      ('Manufacture: RPI Data and QC Inspection', 'Wastage', 'WASTAGE', 3, 6),
                      ('Manufacture: RPI Data and QC Inspection', 'Inspector', 'SIGN(INSPECTOR)', 3,
                       7),
                      ('Racking Prep', 'Start', 'AWAIT(RACKING)', 3, 1),
                      ('Racking Prep', 'Rack Level Type', 'PRODUCT(rackType)', 1, 2),
                      ('Racking Prep', 'Quantity', 'JOB()', 2, 3),
                      ...
                      ('Stacking and Strapping', 'Quantity', 'PRODUCT(packSize)', 3, 2),
