...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Material', 'PRODUCT(material)', 1, 1),
                      ...
                      ('Manufacture: First Off QC Inspection', 'Operator', 'OPERATOR', 3, 11),
                      ('Manufacture: First Off QC Inspection', 'Inspector', 'SIGN(INSPECTOR)', 3, 12),
                      ('Manufacture: RPI Data and QC Inspection', 'RPI', 'RPI', 3, 1),
                      ('Manufacture: RPI Data and QC Inspection', 'Par', 'string', 3, 2),
                      ('Manufacture: RPI Data and QC Inspection', 'Width', 'int', 3, 3),
                      ('Manufacture: RPI Data and QC Inspection', 'Left', 'float', 3, 4),
                      ('Manufacture: RPI Data and QC Inspection', 'Centre', 'float', 3, 5),
                      ('Manufacture: RPI Data and QC Inspection', 'Right', 'float', 3, 6),
                      ('Manufacture: RPI Data and QC Inspection', 'Wastage', 'WASTAGE', 3, 7),
                      ('Manufacture: RPI Data and QC Inspection', 'Inspector', 'SIGN(INSPECTOR)', 3, 8),
