...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Material', 'PRODUCT(material)', 1, 1),
                      ...
                      ('First Off QC Inspection', 'Operatives', 'SIGN(OP)', 3, 9),
                      ('First Off QC Inspection', 'Operatives', 'SIGN(OP)', 3, 10),
                      ...
                      ('Stacking and Strapping', 'Inserts', 'INSERTS', 2, 2),
                      ('Stacking and Strapping', 'Wastage', 'WASTAGE', 3, 3),
                      ('Stacking and Strapping', 'Operatives', 'SIGN(OP)', 3, 4),
                      ('Stacking and Strapping', 'Operatives', 'SIGN(OP)', 3, 4),
