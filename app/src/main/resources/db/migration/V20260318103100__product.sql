...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Material', 'PRODUCT(material)', 1, 1),
                      ...
                      ('Manufacture: RPI Data and QC Inspection', 'Width', 'int', 3, 1),
                      ('Manufacture: RPI Data and QC Inspection', 'Left', 'float', 3, 2),
                      ('Manufacture: RPI Data and QC Inspection', 'Centre', 'float', 3, 3),
                      ('Manufacture: RPI Data and QC Inspection', 'Right', 'float', 3, 4),
                      ('Manufacture: RPI Data and QC Inspection', 'Wastage', 'WASTAGE', 3, 5),
                      ('Manufacture: RPI Data and QC Inspection', 'Inspector', 'SIGN(INSPECTOR)', 3, 6),
