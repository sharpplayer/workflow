...
VALUES ('Material Logistics', (1 | 2), '{}', TRUE),
       ...
       ('Palletising and Shrinkwrap', (1 | 64 | 128), '{}', TRUE),
       ('Bearers, Labels, Shrinkwrap', (1 | 64 | 128), '{}', TRUE),
       ('Storage', (1 | 64), '{}', TRUE),
...
FROM phase p
         JOIN (VALUES ('Material Logistics', 'Free Issue', 'PRODUCT(freeIssue)', 1, 1),
                      ...
                      ('RPI Data and QC Inspection', 'Inspector', 'SIGN(INSPECTOR)', 3,
                       9),
                      ('RPI Data and QC Inspection', 'Wastage', 'WASTAGE', 4, 10),
                      ...
                      ('Palletising and Shrinkwrap', 'Holding Bay', 'string', 3, 1),
                      ('Palletising and Shrinkwrap', 'Quantity', 'int', 3, 2),
                      ('Palletising and Shrinkwrap', 'Wastage', 'WASTAGE', 4, 3),
                      ('Palletising and Shrinkwrap', 'Operator', 'SIGN(PALLETISING)', 4, 3),
