    ...
    <div class="schedule-list-container">
      <div class="controls">
        <mat-form-field appearance="fill">
          ...
          >
            <mat-option [value]="null">Select machine</mat-option>

            @for (machine of machines(); track machine.id) {
              <mat-option [value]="machine.id">
                {{ machine.name }}
              </mat-option>
            }
          </mat-select>
              ...
              <tr>
                <td>
                  <span
                    ...
                    [ngClass]="getDueClass(job.dueDate)"
                  >
                ...
                <td>{{ formatTime(job.actualStart) }}</td>
                <td>{{ formatTime(job.actualFinish) }}</td>
